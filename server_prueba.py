...
class CalculatorServicer(calculator_pb2_grpc.CalculatorServicer):
    ...
    def Despegar(self, request, context):
        response = calculator_pb2.Avion()
        response.confirmacion = calculator.confirmacion(request.confirmacion)
        return response
...
calculator_pb2_grpc.add_DespegueServicer_to_server(CalculatorServicer(), server)
