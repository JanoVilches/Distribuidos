...
_ATERRIZARREPLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='espera', full_name='AterrizarReply.espera', index=0,
...
_ENTRAR = _descriptor.ServiceDescriptor(
  name='Entrar',
  full_name='Entrar',
  file=DESCRIPTOR,
  index=1,
...
_sym_db.RegisterServiceDescriptor(_ENTRAR)

DESCRIPTOR.services_by_name['Entrar'] = _ENTRAR
